   ...
   <main>
        ...
        <div class="trendzbox">
            ...
            <div class="s">
                ...
                <div class="view1">
                    <a href="item1.php"><button class="button view" >View Item</button></a>
                </div>
                ...
                <div class="view1">
                    <a href="item2.php"><button  class="button view">View Item</button></a>
                </div>
                ...
                <div class="view1">
                    <a href="item3.php"><button class="button view">View Item</button></a>
                </div>
