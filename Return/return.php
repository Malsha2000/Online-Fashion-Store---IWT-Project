...
if(isset($_POST['verify'])){
	...
	$emails=$_POST["emailr"];
	$contact=$_POST["cnum"];
	$ordernum=$_POST["ordern"];
	
	$new="INSERT INTO returns(re_id,order_name,email,phone)VALUES('','$ordernum','$emails','$contact')";
...
<hr>
    <main>
<div class="clip">
    <h1 style="color: white; opacity: 0.7; font-family: 'Quicksand', sans-serif;font-size: 24px;">Return &</br> Refund</h1>
</div>
